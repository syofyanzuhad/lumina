...
return 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/firefox/firefox-original.svg';
}

    if (lower.includes('safari')) {
return 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/safari/safari-original.svg';
}

    if (lower.includes('edge')) {
return 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/edge/edge-original.svg';
}

    if (lower.includes('opera')) {
return 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/opera/opera-original.svg';
}

    if (lower.includes('brave')) {
return 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/brave/brave-original.svg';
}
...
return 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/windows11/windows11-original.svg';
}

    if (lower.includes('mac') || lower.includes('os x') || lower.includes('macos') || lower.includes('darwin')) {
