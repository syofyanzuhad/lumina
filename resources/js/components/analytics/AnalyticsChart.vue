...
<template>
    ...
    >
        ...
        >
            <div class="flex items-center gap-2">
                ...
                <span
                    ...
                    class="hidden items-center gap-1 rounded-full bg-emerald-500/10 px-2 py-0.5 text-[10px] font-medium text-emerald-600 dark:text-emerald-400 sm:inline-flex"
                >
        ...
        <div class="relative flex h-48 w-full gap-2 pt-6 pb-2 sm:h-56">
            ...
            <!-- Chart Canvas & Bars -->
            <div class="group/chart relative flex h-full flex-1 items-end gap-1">
                <!-- Background Horizontal Gridlines -->
                <div class="pointer-events-none absolute inset-0 flex flex-col justify-between">
                    <!-- Top Guideline (100%) -->
                    <div class="w-full border-t border-dashed border-sidebar-border/60 dark:border-sidebar-border/40"></div>
                    <!-- Mid Guideline (50%) -->
                    <div class="w-full border-t border-dashed border-sidebar-border/40 dark:border-sidebar-border/25"></div>
                    <!-- Bottom Guideline (0%) -->
                    <div class="w-full border-t border-sidebar-border/70 dark:border-sidebar-border/60"></div>
                </div>
                ...
                >
                    ...
                    <div
                        v-if="isCurrentPeriod(day.date)"
                        class="pointer-events-none absolute -top-3 z-10 hidden sm:flex items-center justify-center"
                        title="Current in-progress period"
                    >
                        <span class="h-1.5 w-1.5 rounded-full bg-emerald-500 ring-2 ring-background"></span>
                    </div>
                    ...
                    >
                        ...
                        <div
                            ...
                            :class="[
                                isCurrentPeriod(day.date)
                                    ? 'bg-gradient-to-t from-indigo-500 to-indigo-400 border-t border-emerald-400 group-hover:from-indigo-600 group-hover:to-indigo-500 dark:from-indigo-500 dark:to-indigo-400'
                        ...
                        <div
                            ...
                            :class="[
                                isCurrentPeriod(day.date)
                                    ? 'bg-indigo-500/45 border-t border-emerald-400/70 group-hover:bg-indigo-500/65 dark:bg-indigo-400/45 dark:group-hover:bg-indigo-400/65'
        ...
        <div
            ...
            class="flex items-center justify-between border-t border-sidebar-border/40 pl-8 pt-2 font-mono text-[9px] text-muted-foreground sm:pl-10 sm:text-[10px]"
        >
