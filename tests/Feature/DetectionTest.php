...
test('country helper resolves common country codes', function () {
...
test('insert event job parses user agent and resolves detection fields', function () {
...
test('analytics service returns top browsers os and countries', function () {
    $site = Site::factory()->create(['domain' => 'example.com']);
